...
pub struct SuperBlock {
    ...
    /*92   95   4 */
    optional_features_flag: u32, // TODO: OptionalFeaturesFlag,
...
impl RequiredFeaturesFlags {
    pub fn from(f: u32) -> Self { Self(f) }

    pub fn contains(&self, flag: RequiredFeaturesFlag) -> bool {
        (self.0 & flag as u32) == flag as u32
    }
}

#[derive(Debug, Clone, Copy)]
pub enum RequiredFeaturesFlag {
    CompressionIsUsed = 0x1,
    DirectoryEntriesContainTypeField = 0x2,
    FileSystemNeedsToReplayJournal = 0x4,
    FileSystemUsesJournalDevice = 0x8,
}
